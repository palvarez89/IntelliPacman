...
(define-project :name :pract2
  :modules (list (make-instance 'module :name "fich1")
                 (make-instance 'form-module :name "form1" :finder-function 'dialogoppal
                                :has-pixmap-file nil)
                 (make-instance 'module :name "fichAprendizaje"))
  :projects nil
  :libraries nil
  :editable-files nil
